...
install_x-ui() {
    ...
    curl -4fLRo /usr/bin/x-ui-temp https://raw.githubusercontent.com/nodly2026/nodly/refs/heads/main/x-ui.sh
    if [[ $? -ne 0 ]]; then
    ...
    if [[ $release == "alpine" ]]; then
        curl -4fLRo /etc/init.d/x-ui https://raw.githubusercontent.com/nodly2026/nodly/refs/heads/main/x-ui.rc
        if [[ $? -ne 0 ]]; then
        ...
        if [ "$service_installed" = false ]; then
            ...
            case "${release}" in
                ubuntu | debian | armbian)
                    curl -4fLRo ${xui_service}/x-ui.service https://raw.githubusercontent.com/nodly2026/nodly/refs/heads/main/x-ui.service.debian >/dev/null 2>&1
                ;;
                *)
                    curl -4fLRo ${xui_service}/x-ui.service https://raw.githubusercontent.com/nodly2026/nodly/refs/heads/main/x-ui.service.rhel >/dev/null 2>&1
                ;;
            esac
